...
Select a date between January 1, 2006 and December 31, 2006.

Search for and select an Indian city.

Click ENTER THE ARCHIVE.

The frontend requests /api/capsule.

The results are displayed as a historical timeline.

Use START AGAIN to return to the input screen.
